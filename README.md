...
入力欄をタップすると、iPhone / iPad のキーボードのマイクから音声入力できます。ホームの「声で入れる」ボタンが端末やブラウザでうまく動かない場合も、キーボードのマイク入力を使えばそのまま保存できます。

iOSショートカットから声で残す場合は、`docs/IOS_SHORTCUTS.md` の「声でひとことを残すショートカット」を見てください。
...
## OpenAI API はまだ使っていません

v0 の分析はルールベースです。OpenAI API は未使用です。
